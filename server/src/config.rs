...
pub struct Config {
    ...
    /// host of assets server
    pub assets_host_grpc: String,
    /// port of assets server
    pub assets_port_grpc: u16,
...
impl Config {
    ...
    pub fn new() -> Self {
        Config {
            ...
            assets_port_grpc: 50051,
            assets_host_grpc: String::from("svc-assets"),
    ...
    pub fn try_from_env() -> Result<Self, ConfigError> {
        ...
        config::Config::builder()
            ...
            .set_default("assets_host_grpc", default_config.assets_host_grpc)?
            .set_default("assets_port_grpc", default_config.assets_port_grpc)?
...
mod tests {
    ...
    async fn test_config_from_default() {
        ...
        assert_eq!(config.assets_port_grpc, 50051);
        assert_eq!(config.assets_host_grpc, String::from("svc-assets"));
    ...
    async fn test_config_from_env() {
        ...
        std::env::set_var("ASSETS_HOST_GRPC", "test_host_grpc");
        std::env::set_var("ASSETS_PORT_GRPC", "12345");
        ...
        assert_eq!(config.assets_port_grpc, 12345);
        assert_eq!(config.assets_host_grpc, String::from("test_host_grpc"));
